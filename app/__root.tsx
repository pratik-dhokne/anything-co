  ...
  head: () => ({
    meta: [
      ...
      { title: "Anything.co - One Request. Countless Possibilities." },
      {
        name: "description",
        content:
          "Anything.co connects you with verified professionals for home, vehicle, tech, event and expert services.",
      },
      { name: "author", content: "Anything.co" },
      { property: "og:site_name", content: "Anything.co" },
